        ...
        <table id="mytable" class="table-bordered table-condensed">
          ...
          <tbody>
            ...
            <tr>
              <td>季目標</td>
              <td>
                <input size="14" type="text" v-model="season_month_target">
              </td>
              <td>
                <input size="14" type="text" v-model="season_today_target">
              </td>
              <td>
                <input size="14" type="text" v-model="season_now_total">
              </td>
              <td>
                <input size="14" type="text" v-model="season_difference">
              </td>
            </tr>
            <tr>
              <td>年目標</td>
              <td>
                <input size="14" type="text" v-model="year_month_target">
              </td>
              <td>
                <input size="14" type="text" v-model="year_today_target">
              </td>
              <td>
                <input size="14" type="text" v-model="year_now_total">
              </td>
              <td>
                <input size="14" type="text" v-model="year_difference">
              </td>
            </tr>
          </tbody>
        </table>
...
export default {
  ...
  mounted: () => {
    ...
    $(document).ready(function() {
      ...
      // 格式化 差額
      $('.imw_diff,.il_diff,.pp_diff,.mi_diff,.bb_diff,.ha_diff,.imm_diff,.hp_diff').each(function() {
        var _val = $(this).html();
        _val = parseInt(_val);
